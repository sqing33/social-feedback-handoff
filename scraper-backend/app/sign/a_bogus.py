...
复制自 TikTokDownloader (src/encrypt/aBogus.py)，移除 src.custom 依赖。
"""
...
class ABogus:
    ...
    @staticmethod
    def random_list(a=None, b=170, c=85, d=0, e=0, f=0, g=0) -> list:
        r = a or (random() * 10000)
    ...
    def generate_string_2(
        ...
        a = self.generate_string_2_list(url_params, method, start_time, end_time, argument)
        e = self.end_check_num(a)
        a.extend(self.browser_code)
        a.append(e)
        return self.rc4_encrypt(self.from_char_code(*a), "y")

    def generate_ua_code(self, user_agent, argument=14):
        ua_key = self.from_char_code(0, 1, argument)
        u = self.rc4_encrypt(user_agent, ua_key)
    ...
    def generate_string_2_list(
        ...
        ua_code = self.ua_code if argument == 14 else self.generate_ua_code(self.user_agent, argument)
        return self.list_4(
            (end_time >> 24) & 255,
            params_array[21],
            ua_code[23],
    ...
    def generate_f(cls, e):
        ...
        for t in range(16):
            r[t] = (
                (e[4 * t] << 24) | (e[4 * t + 1] << 16) | (e[4 * t + 2] << 8) | e[4 * t + 3]
            )
            r[t] &= 0xFFFFFFFF
    ...
    @staticmethod
    def list_4(a, b, c, d, e, f, g, h, i, j, k, m, n, o, p, q, r, argument=14):
        return [
            44, a, 0, 0, 0, 0, 24, b, n, 0, c, d, 0, 0, 0, 1, 0, 239,
            e, o, f, g, 0, 0, 0, 0, h, 0, 0, argument, i, j, 0, k, m, 3,
            p, 1, q, 1, r, 0, 0, 0,
        ]
    ...
    def generate_browser_info(cls, platform="Win32"):
        ...
        value_list = [
            ...
            outer_width, outer_height, inner_width, inner_height, 24, 24, platform,
        ]
    ...
    def get_value(
        ...
        string_2 = self.generate_string_2(
            ...
            method, start_time, end_time, argument,
        )
