...
class Page:
    ...
    def navigate(self, url: str, *, keyword: str = "") -> None:
        """导航到指定 URL。"""
    ...
    def click_element(self, selector: str) -> None:
        ...
        box = self.evaluate(
            ...
            (() => {{
                ...
                const container = target.closest(".note-scroller, .interaction-container");
                if (container) {{
    ...
    def get_scroll_top(self) -> int:
        ...
        result = self.evaluate(
            "(() => { const target = document.querySelector('.note-scroller')"
            " || document.querySelector('.interaction-container');"
            " return target ? target.scrollTop : (window.pageYOffset || "
    ...
    def get_viewport_height(self) -> int:
        ...
        result = self.evaluate(
            "(() => { const target = document.querySelector('.note-scroller')"
            " || document.querySelector('.interaction-container');"
            " return target ? target.clientHeight : window.innerHeight; })()"
        )
    ...
    def dispatch_wheel_event(self, delta_y: float, selector: str | None = None) -> None:
        ...
        self.evaluate(
            f"""
            (() => {{
                let target = {target_expr} || document.documentElement;
